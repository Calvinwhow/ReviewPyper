...
output_dir='/Users/rm026/Documents/code/ReviewPyper_testing/tests/msa_smaller_chunks_gpt3/'
...
import os
import json
inclusion_questions = json.load(open('inclusion_questions.json'))[inclusion_question_sets]
# TODO: extraction_questions is a dict, but only the keys (the questions) are used. Either 
# rearrange so that the values indicate acceptable outputs, or just make it a tuple.
extraction_questions = json.load(open('extraction_questions.json'))[extraction_question_sets]
